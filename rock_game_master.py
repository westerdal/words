#!/usr/bin/env python3
"""
Rock Word Game Master - A game master for the secret word "rock"
"""
import csv
import re
from typing import Dict, List, Tuple, Optional

class RockGameMaster:
    def __init__(self):
        self.word_data: Dict[str, Dict] = {}
        self.dictionary: set = set()
        self.game_started = False
        self.secret_word = "rock"
    ...
    def initialize_game(self):
        ...
        print("🔄 Loading ROCK game data...")
        
        # Load word data
        if not self.load_word_data('secretword/secretword-easy-animals-rock.csv'):
            return False
        print(f"✅ Loaded {len(self.word_data)} words for ROCK")
    ...
    def start_game(self):
        ...
        print("\n" + "="*60)
        print("🪨 ROCK WORD GUESSING GAME READY! 🪨")
        print("="*60)
    ...
    def display_result(self, result: dict):
        ...
        if result.get("winner"):
            print("\n" + "🪨" * 20)
            print("🏆 CONGRATULATIONS! YOU FOUND THE ROCK! 🏆")
            print("🪨" * 20)
    ...
    def display_leaderboard(self):
        ...
        print("\n🪨 GEOLOGICAL LEADERBOARD (Best Guesses) 🪨")
        print("-" * 60)
...
rock_game = RockGameMaster()

def setup_rock_game():
    """Setup and start the rock game"""
    if rock_game.initialize_game():
        rock_game.start_game()
        return True
    return False

def make_rock_guess(word: str):
    """Make a guess in the rock game"""
    result = rock_game.process_guess(word)
...
if __name__ == "__main__":
    if setup_rock_game():
        print("🪨 ROCK game ready! Use make_rock_guess('your_word') to play!")
    else:
        print("❌ Failed to setup ROCK game!")
