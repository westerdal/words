#!/usr/bin/env python3
"""
Queen Word Game Master - A game master for the secret word "queen"
"""
import csv
import re
from typing import Dict, List, Tuple, Optional

class QueenGameMaster:
    def __init__(self):
        self.word_data: Dict[str, Dict] = {}
        self.dictionary: set = set()
        self.game_started = False
        self.secret_word = "queen"
    ...
    def initialize_game(self):
        ...
        print("🔄 Loading QUEEN game data...")
        
        # Load word data
        if not self.load_word_data('secretword/secretword-easy-animals-queen.csv'):
            return False
        print(f"✅ Loaded {len(self.word_data)} words for QUEEN")
    ...
    def start_game(self):
        ...
        print("\n" + "="*60)
        print("👑 QUEEN WORD GUESSING GAME READY! 👑")
        print("="*60)
    ...
    def display_result(self, result: dict):
        ...
        if result.get("winner"):
            print("\n" + "👑" * 20)
            print("🏆 CONGRATULATIONS! YOU FOUND THE QUEEN! 🏆")
            print("👑" * 20)
    ...
    def display_leaderboard(self):
        ...
        print("\n👑 ROYAL LEADERBOARD (Best Guesses) 👑")
        print("-" * 60)
...
queen_game = QueenGameMaster()

def setup_queen_game():
    """Setup and start the queen game"""
    if queen_game.initialize_game():
        queen_game.start_game()
        return True
    return False

def make_queen_guess(word: str):
    """Make a guess in the queen game"""
    result = queen_game.process_guess(word)
...
if __name__ == "__main__":
    if setup_queen_game():
        print("👑 QUEEN game ready! Use make_queen_guess('your_word') to play!")
    else:
        print("❌ Failed to setup QUEEN game!")
