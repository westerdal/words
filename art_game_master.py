#!/usr/bin/env python3
"""
Art Word Game Master - A game master for the secret word "art"
"""
import csv
import re
...
class ArtGameMaster:
    ...
    def initialize_game(self):
        ...
        print("🔄 Loading ART game data...")
        
        # Load word data
        if not self.load_word_data('secretword/secretword-easy-animals-art.csv'):
            return False
        print(f"✅ Loaded {len(self.word_data)} words for ART")
    ...
    def start_game(self):
        ...
        print("\n" + "="*60)
        print("🎨 ART WORD GUESSING GAME READY! 🎨")
        print("="*60)
    ...
    def display_result(self, result: dict):
        ...
        if result.get("winner"):
            print("\n" + "🎨" * 20)
            print("🏆 CONGRATULATIONS! YOU FOUND THE ART! 🏆")
            print("🎨" * 20)
    ...
    def display_leaderboard(self):
        ...
        print("\n🎨 ARTISTIC LEADERBOARD (Best Guesses) 🎨")
        print("-" * 60)
...
art_game = ArtGameMaster()

def setup_art_game():
    """Setup and start the art game"""
    if art_game.initialize_game():
        art_game.start_game()
        return True
    return False

def make_art_guess(word: str):
    """Make a guess in the art game"""
    result = art_game.process_guess(word)
...
if __name__ == "__main__":
    if setup_art_game():
        print("🎨 ART game ready! Use make_art_guess('your_word') to play!")
    else:
        print("❌ Failed to setup ART game!")
